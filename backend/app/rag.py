...
class RAGEngine:
    ...
    def _refine_question(self, question: str, history: list) -> str:
        ...
        try:
            ...
            prompt = (
                ...
                "5. Do NOT answer the question - only reformulate it for better retrieval\n"
                "6. Do NOT mention specific parts of the text\n"
                "7. If the user is asking for a derivation or proof, reformulate the query to all the relevant steps and concepts involved\n"
                "8. If the user is asking for a definition or explanation, provide an informative reformulation\n\n"
    ...
    def _generate_answer(self, original_question: str, refined_question: str, contexts: list, history: list, pages_used: list = None):
        ...
        prompt = (
            ...
            "- NEVER reference problems, exercises, questions, or their answers\n\n"
            "EXAMPLE FORMAT:\n"
